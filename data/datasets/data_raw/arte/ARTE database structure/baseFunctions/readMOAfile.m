% function [sMOA,fs] = readMOAfile(nameMOA,MOAch,range)
%
% Reads a multi-channel MOA file.
%
% Inputs:
% nameMOA  Path and name of considered MOA sound file.
...
if exist('range','var') % if range is defined as input variable
    ...
    [sMOA,fs] = audioread(nameMOA,range);% read part of 31-channel MOA sound file
else
    disp('Reading entire MOA sound file...')
    [sMOA,fs] = audioread(nameMOA);% read entire 31-channel MOA sound file
end
