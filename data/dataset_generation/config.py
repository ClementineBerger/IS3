...
IMPULSES_EVENT_MAP_FP = os.path.join(ASSETS_PATH, 'impulses_event_mapping.tsv')
IMPULSES_ROOT_FP = os.path.join(ASSETS_PATH, 'impulses_roots.json')

SCENES_MAP_FP = os.path.join(ASSETS_PATH, 'audible_scene_mapping.tsv')
SCENES_ROOT_FP = os.path.join(ASSETS_PATH, 'audible_scene_roots.json')

SAVING_ROOT_DIR = os.path.join(
    os.environ["DATA_DIR"],
